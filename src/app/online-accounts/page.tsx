    ...
    <div className="min-h-screen bg-slate-50">
      <div className="container-lg py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">My Online Accounts</h1>
            <p className="text-slate-600 mt-2">Document your online accounts and access information</p>
          </div>
            ...
            {loading ? (
              ...
              <div className="card p-0 overflow-hidden" style={{ height: "70vh" }}>
                <div className="bg-primary-600 text-white p-4">
                  <h2 className="text-xl font-semibold">Online Accounts Assistant</h2>
                  <p className="text-sm opacity-80">Get help organizing your online account information</p>
                </div>
                <div className="h-full">
                  <EstatePlanningAssistant moduleType="online-accounts" />
                </div>
              </div>
            ) : null}
          </div>
          ...
          <div className="space-y-6">
            <div className="card">
              ...
              <p className="text-slate-600 mb-4">
                The Online Accounts module helps you create a secure inventory of all your important 
                online accounts, including:
              </p>
              ...
              <p className="text-slate-600">
                This information will be securely stored and only accessible to your authorized contacts 
            ...
            <div className="card">
              ...
              <p className="text-slate-600 mb-4">
                Most people have dozens of online accounts that their loved ones don't know about. 
                Without proper documentation, these accounts may:
              </p>
              <ul className="list-disc list-inside text-slate-600 ml-2">
                <li>Become inaccessible forever</li>
                <li>Continue charging subscription fees</li>
                <li>Create identity theft opportunities</li>
                <li>Prevent access to important digital assets</li>
              </ul>
            </div>
          </div>
        </div>
